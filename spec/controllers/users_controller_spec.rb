  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should have delete links for admin" do
        ...
        get :index
        response.should have_selector("a", :href => user_path(other_user.id), :content => "delete")
      end
      
      it "should not have delete links for non-admin" do
        other_user = User.all.second
        get :index
        response.should_not have_selector("a", :href => user_path(other_user.id), :content => "delete")
      end
